...
impl Plugin for CameraPlugin {
    fn build(&self, app: &mut App) {
        app.add_systems(Update, move_camera.in_set(InGameSet::EntityUpdate));
    }
}
...
// TODO
fn move_camera(// mut camera: Query<&mut Transform, (With<GameCamera>, Without<GameCameraTarget>)>,
